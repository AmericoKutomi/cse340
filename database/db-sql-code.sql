...
ALTER TYPE public.account_type OWNER TO cse340ask;
...
CREATE TABLE IF NOT EXISTS public.user_review (
  user_review_id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY,
  account_id integer NOT NULL,
  inv_id integer NOT NULL,
  user_review_comment character varying NOT NULL,
  user_review_grade integer NOT NULL,
  user_review_date timestamp NOT NULL,
  CONSTRAINT user_review_pkey PRIMARY KEY (user_review_id)
);
-- Create relationship between `user_review` and `inventory` tables
...
-- Create relationship between `user_review` and `account` tables
ALTER TABLE IF EXISTS public.user_review
