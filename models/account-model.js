...
/* *****************************
 *   Update an existing account: basic information
 * *************************** */
async function updateAccountBasic(
  account_firstname,
  account_lastname,
  account_email,
  account_id,
  ...
  let accountData = '';
  accountData = await getAccountById(parseInt(account_id));
  // verify if there was a change in email
